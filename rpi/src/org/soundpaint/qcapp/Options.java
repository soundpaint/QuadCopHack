...
public class Options
{
  ...
  static public class OptionDeclaration
  {
    ...
    private OptionDefinition<?> define()
      throws ParseException
    {
  ...
  abstract static private class OptionDefinition<T>
  {
  ...
  static public class FlagOptionDefinition extends OptionDefinition<Boolean>
  {
  ...
  static public class BooleanOptionDefinition extends OptionDefinition<Boolean>
  {
  ...
  static public class StringOptionDefinition extends OptionDefinition<String>
  {
  ...
  private OptionDeclaration[] declarations;
  private OptionDefinition<?>[] definitions;

  public Options(final OptionDeclaration[] declarations) throws ParseException
  {
  ...
  {
    final StringBuffer sb = new StringBuffer();
    for (OptionDeclaration declaration : declarations) {
      sb.append(declaration.getHelp());
    }
    return sb.toString();
  }

  private final static OptionDefinition<?>[] EMPTY_DEFINITIONS =
    new OptionDefinition<?>[0];

  private void createDefinitions() throws ParseException
  {
    ...
    definitions = definitionList.toArray(EMPTY_DEFINITIONS);
  }
